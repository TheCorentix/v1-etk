  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10 space-y-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="relative aspect-[3/4] bg-neutral-50 border border-[#ECECEC] overflow-hidden cursor-crosshair group"
          >
            <img
              src={activeImage}
              alt={product.name}
          ...
          {/* Video player loop */}
          {product.video && (
            <div className="relative aspect-[16/9] w-full border border-[#ECECEC] bg-neutral-950 overflow-hidden mt-6">
              <video
                src={product.video}
                autoPlay
                muted={videoMuted}
        ...
        <div className="space-y-8 md:pl-6">
          ...
          <div className="space-y-3">
            <div className="space-y-1">
              ...
              <h1 className="text-3xl font-serif font-light text-text-custom uppercase tracking-wider leading-tight">
                {product.name}
              </h1>
            </div>
          ...
          {uniqueColors.length > 0 && (
            <div className="space-y-3">
              <span className="text-[10px] tracking-widest text-neutral-400 font-sans uppercase font-medium block">
                CHOOSE COLOR: <span className="text-neutral-800 font-bold">{selectedColor}</span>
              </span>
          ...
          {uniqueFabrics.length > 0 && (
            <div className="space-y-3">
              <span className="text-[10px] tracking-widest text-neutral-400 font-sans uppercase font-medium block">
                CHOOSE WEAVE: <span className="text-neutral-800 font-bold">{selectedFabric}</span>
              </span>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 border text-xs tracking-wider uppercase transition-all duration-300 font-sans focus:outline-none ${
                      selectedFabric === fab
                        ...
                        : 'border-neutral-200 hover:border-[#B68D40] text-neutral-600'
                    }`}
                  >
                    {fab}
                  </button>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center border border-neutral-300 bg-[#F8F6F2] w-28 justify-between">
              <button
              ...
              <span className="font-sans font-semibold text-xs text-[#181818]">{qty}</span>
              <button
          ...
          {product.customizationAvailable && (
            <div className="bg-[#F8F6F2] border border-[#D9C7A3] p-4 space-y-2">
          ...
          <div className="space-y-4">
            <div className="flex border-b border-[#ECECEC] text-[10px] font-sans font-semibold tracking-widest uppercase">
            ...
            {/* Tab contents panel */}
            <div className="text-xs font-sans text-neutral-600 leading-relaxed min-h-24">
              ...
              {activeTab === 'details' && (
                <div className="space-y-3.5 uppercase tracking-wider text-[10px]">
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-neutral-800">{product.careInstructions}</span>
                  </div>
                  <div>
              ...
              {activeTab === 'sizeguide' && (
                <div className="space-y-4">
                  ...
                  <table className="w-full border-collapse border border-neutral-200 text-left text-[10px] uppercase">
                    <thead>
                      <tr className="bg-neutral-50 border-b border-neutral-200 font-semibold text-[#B68D40]">
              ...
              {activeTab === 'reviews' && (
                <div className="space-y-4 max-h-64 overflow-y-auto custom-scrollbar pr-2">
                  {reviews.length > 0 ? (
                    reviews.map((rev) => (
                      <div key={rev.id} className="border-b border-[#ECECEC] pb-3 space-y-1">
                        <div className="flex justify-between items-center">
                          <span className="font-semibold text-neutral-800">{rev.userName}</span>
      ...
      {product.relatedProductsData && product.relatedProductsData.length > 0 && (
        <section className="space-y-10 border-t border-[#ECECEC] pt-16">
          <div className="text-center space-y-2">
            <span className="text-[10px] uppercase tracking-[0.25em] text-[#B68D40] font-sans font-semibold">COUTURE MATCHES</span>
            <h3 className="text-2xl font-serif font-light tracking-wide text-text-custom uppercase">
              Related Garments
            </h3>
